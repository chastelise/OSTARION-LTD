...
const ProductCarousel = () => {
  ...
  return (
    <section id="products" className="py-24 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="flex w-max animate-product-marquee hover:[animation-play-state:paused]">
